...
class Exercise1 {
    static tableToProductSummary(productSummaryId) {
        let table = document.getElementById(productSummaryId);
...
class Exercise2 {
    static tableToProductDetail(productDetailId) {
        let table = document.getElementById(productDetailId);
        let rows = Array.from(table.tBodies[0].rows);
        return rows.map(r => ({
